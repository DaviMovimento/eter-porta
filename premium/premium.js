...
function montarChegada() {
  ...
  if (caixaPasse && !caixaPasse.querySelector('.mock-passe')) {
    ...
    f.innerHTML = `<img src="${CASA}mockup-assinatura.webp?v=202608232220"
    ...
    cx.innerHTML = `
      <div class="painel oferta">
        ...
        <figure class="mock-passe">
          <img src="${CASA}mockup-assinatura.webp?v=202608232220"
...
function montarFundo() {
  ...
  const atm = $('#atmosfera');
  const parede = `${BASE}edicoes/${EDICAO.n}/parede.webp?v=202608232220`;
...
function blocoFim() {
  ...
  d.innerHTML = `
    ...
    <section class="passe">
      <figure class="mock-passe"><img src="${CASA}mockup-assinatura.webp?v=202608232220"
