...
function montarChegada() {
  ...
  if (caixaPasse && !caixaPasse.querySelector('.mock-passe')) {
    ...
    f.innerHTML = `<img src="${ONDE_MORO.includes('/premium/') ? '' : 'premium/'}mockup-assinatura.webp?v=202608232100"
    ...
    cx.innerHTML = `
      <div class="painel oferta">
        ...
        <figure class="mock-passe">
          <img src="${ONDE_MORO.includes('/premium/') ? '' : 'premium/'}mockup-assinatura.webp?v=202608232100"
...
function montarFundo() {
  ...
  const atm = $('#atmosfera');
  const parede = `${BASE}edicoes/${EDICAO.n}/parede.webp?v=202608232100`;
...
function blocoFim() {
  ...
  d.innerHTML = `
    ...
    <p class="oferta-chamada">${COPY_CASA.chamadaOferta}</p>
    <section class="passe">
      <figure class="mock-passe"><img src="../premium/mockup-assinatura.webp?v=202608232100"
