...
async function iniciar() {
  DADOS = await (await fetch(new URL('../edicoes.json?v=202608261810', ONDE_MORO))).json();
...
function montarChegada() {
  ...
  if (caixaPasse && !caixaPasse.querySelector('.mock-passe')) {
    ...
    f.innerHTML = `<img src="${CASA}mockup-assinatura.webp?v=202608261810"
...
function montarFundo() {
  ...
  const parede = `${BASE}edicoes/${EDICAO.n}/${paredeArq}?v=202608261810`;
...
function blocoFim() {
  ...
  d.innerHTML = `
    ...
    <section class="passe">
      <figure class="mock-passe"><img src="${CASA}mockup-assinatura.webp?v=202608261810"
